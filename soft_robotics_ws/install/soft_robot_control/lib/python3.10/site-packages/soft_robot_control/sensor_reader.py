...
class SensorReader(Node):
    def __init__(self):
        ...
        #self.csv_file_path = '/home/kwasi/Documents/force_sensor_data.csv'  # Update this with the path to your CSV file
        self.csv_file_path = '/home/kwasi/Documents/data_v2.csv'
        ...
        self.get_logger().info('CSV Reader Node initialized and ready to read CSV file.')
...
def main(args=None):
    ...
    try:
        ...
        sensor_reader_node.get_logger().info('Node stopped by user.')
    finally:
